...
export const logData = (measureName: string, metric: any, customProperties?: object): void => {
  ...
  //   console.log(metric,777777)
  // }
  // if(measureName === 'storageEstimate'){
  //   console.log(metric,888888)
  // }
